# DisplayName: Jolla titan/@ARCH@ (release) 1
...
repo --name=adaptation0-titan-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-motorola-titan/@ARCH@/
...
%packages
@Jolla Configuration titan
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/titan
